...
title = NDOT Field Tests

# (str) Package name
package.name = fieldtests

# (str) Package domain (needed for android/ios packaging)
package.domain = org.ndot
...
requirements = python3,kivy,plyer,pyjnius==1.4.0,Cython==0.29.36
...
android.permissions = INTERNET, android.permission.WRITE_EXTERNAL_STORAGE, android.permission.READ_EXTERNAL_STORAGE
...
#       [app]
#       title = NDOT Field Tests # This is not a comment, it is part of the title.
#
#   Warning: Indented text is treated as a multiline string - i.e.
#       [app]
#       title = NDOT Field Tests
#          package.name = fieldtests # This is all part of the title.
#
